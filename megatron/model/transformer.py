...
#            )
    ...
    def forward(self, hidden_states):
        #normalized_embeds = F.normalize(self.final_linear.weight, p=2.0, dim=1)
        #normalized_feats = F.normalize(hidden_states, p=2.0, dim=-1)
        
        #logits = F.linear(normalized_feats, normalized_embeds)
        #return logits, None
