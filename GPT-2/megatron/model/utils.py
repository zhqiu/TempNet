...
def get_params_for_weight_decay_optimization(module, neox_args):
    ...
    if neox_args.use_tempnet:
        tempnet_params = {"params": [], "lr": neox_args.tempnet_lr}

    for name, param in module.named_parameters():
        if neox_args.use_tempnet and 'tempnet' in name:
            tempnet_params["params"].append(param)
    ...
    if neox_args.use_tempnet:
        return weight_decay_params, no_weight_decay_params, tempnet_params
    else:
